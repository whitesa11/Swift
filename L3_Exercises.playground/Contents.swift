...
var sample = Array(repeating: "true", count: 5)
...
var namesOfDictionary = [String: Bool]()
//: b) Initialize a dictionary using array literal syntax. The keys should be the Strings: "Anchovies", "Coconut", "Cilantro", "Liver"  and each value should be a Bool representing whether you like the food or not.
 ...
 namesOfDictionary = ["Anchovies": true, "Coconut": true, "Cilantro": false, "Liver": true]
...
var msObama = presidentialDogs["Barack Obama"]
print("Michele Obama walks\(String(describing: msObama)) every morning.")
